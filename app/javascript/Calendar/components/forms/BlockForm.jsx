...
const SortableItem = SortableElement(
  ({ excercise, blockId, setShowExcerciseDetails }) => (
    <ExcerciseForm
      blockId={blockId}
...
const SortableList = SortableContainer(
  ({ excercises, blockId, setShowExcerciseDetails }) => {
...
function BlockForm(props) {
  ...
  const [showBlockDetails, setShowBlockDetails] = useState(
    props.block.name || props.block.sets
  );
...
const mapDispatchToProps = (dispatch, ownProps) => ({
  addExcercise: () =>
    dispatch(saveNewExcercise({ movement: "", block_id: ownProps.blockId })),
